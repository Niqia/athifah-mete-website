                                    ...
                                    <!-- <div class="col "> -->
                                        <div class="card" style="width: 18rem; margin: 25px;">
                                            <a href="/detail-produk/{{$product->slug}}">
                                                @if($product->image)
                                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{$product->slug}}" class="card-img-top img-thumbnail border-0 img-fluid img-responsive">
                                                @else
                                                    <img src="{{ asset('img/athifah (1).jpg') }}" alt="{{$product->slug}}" class="card-img-top img-thumbnail border-0 img-fluid img-responsive" >
                                                @endif
                                            </a>
